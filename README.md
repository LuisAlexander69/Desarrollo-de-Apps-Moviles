...
Este proyecto proporciona la base del código fuente inicial (`boilerplate`) estructurado según las mejores prácticas en Kotlin.
...
### [Futuro] - Próximos Módulos (Versión Final)
- Implementación de notificaciones locales 100% funcionales (AlarmManager / WorkManager).
- Conexión con base de datos local (Room Database) para persistencia de los hábitos (que no se borren al cerrar la app).
- Mejora en los gráficos interactivos del Dashboard.

### [Actual] - Módulo Actual (Actividad 3)
- Integración del proyecto y código base con el repositorio de GitHub Classroom.
- Adición de esta sección de Changelog (Registro de Cambios) al archivo README.
